          ...
          <div className="relative animate-fade-in-up animation-delay-200">
            ...
            <div className="absolute -bottom-6 -left-6 lg:-left-12 bg-card rounded-2xl p-4 shadow-card animate-bounce-gentle">
              <div className="flex items-center gap-3">
                ...
                <a href="https://www.playfamily.co/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                  <p className="text-sm font-semibold text-foreground leading-tight">Using Award-Winning</p>
